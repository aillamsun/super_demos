...
import com.sung.base.common.constant.BaseConstant;
import com.sung.base.common.constant.EmptyObjectConstant;
import com.sung.base.common.exception.NotExpectedFormatedException;
...
import static com.sung.base.common.constant.EmptyObjectConstant.EMPTY_STRING;
import static com.sung.base.common.constant.RegExpConstant.PATTERN_OF_CONTAINS_IP;
		...
		try {
			...
			if (reader != null) {
				try {
					...
					LogUtils.logError("", e1.getMessage());
				}
			}
		}
		return sb.toString();

...
public class Fastjson2JsonMessageConverter extends AbstractJsonMessageConverter {

	private static Log log = LogFactory.getLog(Fastjson2JsonMessageConverter.class);
